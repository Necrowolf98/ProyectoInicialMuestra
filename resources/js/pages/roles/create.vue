                        ...
                        <v-card outlined>
                                    ...
                                    <v-col class="mb-0 pb-0" cols="12" sm="5" md="12" lg="12" xl="12">
                                        <v-row class="pt-3">
                                            ...
                                            <v-col cols="9" sm="8" md="9" lg="9" xl="9" class="pb-0 mb-0">
                                                <v-text-field v-model="form.name" label="Escriba el nombre del rol" append-icon="fas fa-unlock-alt" dense outlined class="input_form icons_formularios" hint="Por ejemplo Administrador"  :error-messages="form.errors.name">
                                                </v-text-field>
                                            </v-col>
                                        </v-row>
                                    </v-col>
                            ...
                            <v-card-actions class="grey lighten-5 py-0 my-0">
                                <v-col cols="6" class="p-0 m-0">
                                    <v-btn color="blue lighten-1" block small class="text-white" :disabled="form.processing" :loading="form.processing" @click.prevent="AddRolePermissions">
